...
/// </remarks>
/// <param name="Path">Vollstaendiger Pfad der Programmdatei. Leer bei einem Vorbereiter: welche
/// Datei es wird, steht erst nach dem Vorbereiten fest.</param>
/// <param name="Display">Was in der Liste steht - der Pfad relativ zum Projekt, sonst der
/// Dateiname; bei einem Vorbereiter dessen <see cref="IDebugLaunchProvider.DisplayName" />.</param>
/// <param name="Provider">Gesetzt, wenn der Eintrag fuer einen Vorbereiter steht. Dann laeuft der
/// Start ueber <see cref="IDebuggerService.StartAsync(IDebugLaunchProvider, CancellationToken)" />
/// statt ueber eine selbst gebaute Anforderung.</param>
